...
public class NotesDB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sqlnote = "CREATE TABLE "+ TABLE_NAME_NOTES+"("
                         +COLUMN_NAME_ID +" INTEGER PRIMARY KEY AUTOINCREMENT ,"
                        +COLUMN_NAME_NOTE_NAME +" TEXT NOT NULL , "
                         +COLUMN_NAME_NOTE_CONTENT +" TEXT NOT NULL , "
                         +COLUMN_NAME_NOTE_DATE+" TEXT NOT NULL)";
        String sqlmedia = "CREATE TABLE "+ TABLE_NAME_MEDIA+"("
                +COLUMN_NAME_ID +" INTEGER PRIMARY KEY AUTOINCREMENT ,"
